            ...
            <div className="connections">
                <div className="footer-phone">
                    <div className="phone-img">
                        <Image src={"/images/footerphone.svg"} alt='' width={20} height={20}/>
                    </div>
                ...
                <div className="footer-mail">
                    <div className="mail-img">
                        <Image src={"/images/footermail.svg"} alt='' width={20} height={20}/>
                    </div>
                ...
                <div className="footer-map">
                    <div className="map-img">
                        <Image src={"/images/footermap.svg"} alt='' width={20} height={20}/>
