      ...
      {/* second section */}
        <div className="second-section">
          <div className="second-section-top">
            ...
            <div className="top-left">
              <Image src={'/images/cardspreview.svg'} alt="" width={584} height={444}/>
            </div>
        ...
        <div className="third-section">
          <div className="third-left">
            ...
            <div className="third-quote">
              <p>Ready to take the next step towards financial security<span className="fullstop-quote">?</span></p>
            </div>
            <div className="text-desc">
              <p>Contact <span className="sky-text-inbtw">Sky Financial</span> today to schedule a consultation with one of our<br></br> experienced agents. We're here to answer your questions, address your<br></br> concerns, and help you find the perfect insurance solutions for your needs.</p>
            </div>
          </div>
          <div className="third-right">
            <div className="email-box">
              ...
              <div className="name-sub">
                <div className="mail-section">
                  <div className="userimg">
                    <Image src={'/images/usericon.svg'} alt="" width={20} height={20}/>
                  </div>
              ...
              <div className="name-sub">
                <div className="mail-section">
                  <div className="userimg">
                    <Image src={'/images/mailimg.svg'} alt="" width={20} height={20}/>
                  </div>
                  <div className="linebtw"></div>
                ...
                <div className="mail-section">
                  <div className="userimg">
                  <Image src={'/images/phoneimg.svg'} alt="" width={20} height={20}/>
                  </div>
                  <div className="linebtw"></div>
        ...
        <div className="fourth-section">
          ...
          <div className="right-fourth">
            ...
            <div className="who-title">
              <p>Get the Answers You Need<span className="fullstop-quote">.</span></p>
            </div>
            <div className="text-desc">
            ...
            <div className="thinkimg">
              <Image src={'/images/thinkman.svg'} alt="" width={360} height={536}/>
            </div>
          </div>
        </div>
